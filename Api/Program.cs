...
builder.Services.AddDbContext<KardinoTemplateDbContext>(options =>
{
    options.UseSqlServer("name=ConnectionStrings:KardinoTemplateConnection", sqlServerOptionsAction: sqlOptions =>
    {
...
builder.Services.AddMediatR(typeof(Application.LoginApplication.Commands.Login.Command).Assembly);
